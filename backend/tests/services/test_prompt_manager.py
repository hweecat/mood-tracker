...
class TestPromptManager:
    ...
    def test_init_does_not_load_provider_config(self):
        """Test PromptManager initialization is independent of LLM provider config."""
        manager = PromptManager()

        assert not hasattr(manager, "config")
    ...
    async def test_get_distortion_prompt_with_version_not_found(self):
        ...
        with pytest.MonkeyPatch.context() as monkeypatch:
            monkeypatch.setattr("app.services.prompt_manager.get_db", lambda: iter([mock_db]))
