      ...
      <div className="space-y-8">
        {filteredEntries.length === 0 ? (
          ...
          displayedEntries.map((entry) => {
            ...
            if (aiAnalysis) {
              if (aiAnalysis.sentimentScore > 0.3) {
                sentimentColor = 'border-l-lime-400';
                SentimentIcon = Smile;
              } else if (aiAnalysis.sentimentScore < -0.3) {
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {SentimentIcon && aiAnalysis && (
                          <SentimentIcon 
                            className={`w-3.5 h-3.5 opacity-50 group-hover:opacity-100 transition-opacity ${
                              aiAnalysis.sentimentScore > 0.3 ? 'text-lime-600' : 
                              aiAnalysis.sentimentScore < -0.3 ? 'text-rose-600' : 'text-cyan-600'
                            }`} 
                            aria-hidden="true"
                          />
                        )}
